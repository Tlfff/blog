...
type CommentUsecase interface {
	CreateComment(ctx context.Context, articleID, rootID, userID, replyToUserID uint64, content, ip string) (*commentDto.CreateCommentResponse, error)
	ListRootComments(ctx context.Context, articleID, lastID uint64, page, pageSize int, isDesc bool, authorID uint64) (*commentDto.RootCommentListResponse, error)
	ListReplies(ctx context.Context, rootID, lastID uint64, page, pageSize int) (*commentDto.ReplyListResponse, error)
