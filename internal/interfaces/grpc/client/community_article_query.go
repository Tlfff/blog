...
type CommunityArticleQueryClient struct {
	...
	local  domaincommunity.ArticleQuery
}

func NewCommunityArticleQueryClient(remote internalv1.ContentServiceClient, local domaincommunity.ArticleQuery) *CommunityArticleQueryClient {
	return &CommunityArticleQueryClient{remote: remote, local: local}
}

func (c *CommunityArticleQueryClient) FindByID(ctx context.Context, id uint64) (*domaincommunity.ArticleInfo, error) {
...
func (c *CommunityArticleQueryClient) GetHotListByIDs(ctx context.Context, ids []uint64) ([]*domaincommunity.ArticleInfo, error) {
	return c.local.GetHotListByIDs(ctx, ids)
}

func (c *CommunityArticleQueryClient) GetTopHotArticles(ctx context.Context, limit int) ([]*domaincommunity.ArticleInfo, error) {
