...
// GetHotRank 获取文章热榜并补齐文章信息。
func (s *EngagementService) GetHotRank(ctx context.Context) (*articledto.HotRankResponse, error) {
	// 1. 从 Redis 热榜取前 10 名
...
// RebuildHotRank 按数据库统计重建文章热榜。
func (s *EngagementService) RebuildHotRank(ctx context.Context) error {
