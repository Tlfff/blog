...
import (
	...
	"blog/internal/notification/infra/model"
	"context"
...
func toDomainNotification(document *model.Notification) *notificationdomain.Notification {
	...
	if notificationdomain.NotificationType(document.Type) == notificationdomain.NotifyTypeLikeArticle {
	...
	return &notificationdomain.Notification{
		...
		Type:        notificationdomain.NotificationType(document.Type),
