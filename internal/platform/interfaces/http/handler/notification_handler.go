...
import (
	"blog/internal/notification/application/dto"
...
type NotificationUsecase interface {
	GetMyNotifications(ctx context.Context, userID uint64, page, pageSize int64) (*notification.NotificationListResponse, error)
